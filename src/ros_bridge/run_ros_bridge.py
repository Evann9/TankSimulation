...
def _set_direct_run_defaults() -> None:
    ...
    os.environ.setdefault("TANK_YOLO_ASYNC_MAX_RESULT_AGE_MS", "120")
    os.environ.setdefault("TANK_YOLO_ASYNC_WAIT_FOR_FRESH_MS", "35" if yolo_engine_path.exists() else "0")
    os.environ.setdefault("TANK_YOLO_ASYNC_LOG_INTERVAL_SEC", "2.0")
    os.environ.setdefault("TANK_PUBLISH_DETECT_IMAGE", "false")
    os.environ.setdefault("TANK_LIVE_VIEW_FPS", "6")
