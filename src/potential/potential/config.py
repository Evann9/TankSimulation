...
K_ATTRACTIVE = env_float("TANK_APF_K_ATT", 1.0)
K_REPULSIVE = env_float("TANK_APF_K_REP", 500.0)
OBSTACLE_INFLUENCE_RADIUS = env_float("TANK_APF_G_STAR", 15.0)
MAX_ATTRACTIVE_FORCE = env_float("TANK_APF_MAX_ATT_FORCE", 10.0)
MAX_REPULSIVE_FORCE = env_float("TANK_APF_MAX_REP_FORCE", 50.0)
MAX_RESULT_FORCE = env_float("TANK_APF_MAX_RESULT_FORCE", 50.0)
LOCAL_TARGET_DISTANCE = env_float("TANK_APF_LOCAL_TARGET_DISTANCE", 8.0)
REPULSIVE_EPS = env_float("TANK_APF_REP_EPS", 0.05)
...
TANGENTIAL_GAIN_SCALE = env_float("TANK_APF_TANGENTIAL_GAIN", 1.2)

MIN_OBSTACLE_DISTANCE = env_float("TANK_APF_MIN_OBS_DIST", 1.5)
MAX_OBSTACLE_DISTANCE = env_float("TANK_APF_MAX_OBS_DIST", 12.0)
FRONT_SECTOR_DEG = env_float("TANK_APF_FRONT_SECTOR_DEG", 140.0)
PATH_CORRIDOR_WIDTH = env_float("TANK_APF_PATH_CORRIDOR_WIDTH", 7.0)
OBSTACLE_VOXEL_RESOLUTION = env_float("TANK_APF_OBS_VOXEL", 1.0)
MAX_OBSTACLE_POINTS = env_int("TANK_APF_MAX_OBS_POINTS", 300)
